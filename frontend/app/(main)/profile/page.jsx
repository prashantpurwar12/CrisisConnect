...
import { User, Bell, Shield, Award, Calendar, Edit, Save, X, Loader2, MapPin, Star, TrendingUp, LogOut, Trash2, AlertTriangle } from "lucide-react"
...
export default function ProfilePage() {
  ...
  const handleDeleteAccount = async () => {
    setIsDeleting(true)
    try {
      const { deleteAccount } = await import('@/lib/profileApi')
      await deleteAccount()
      ...
      toast({
        title: "Error",
        description: (error && error.message) || "Failed to delete account. Please try again.",
        variant: "destructive"
      })
      setIsDeleting(false)
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <motion.div variants={scaleInVariants}>
              <Card className="border-2 border-destructive/20 hover:border-destructive/50 transition-all duration-300 overflow-hidden">
                <CardHeader>
                  ...
                  {!showDeleteConfirm ? (
                    ...
                    >
                      <div className="p-3 bg-destructive/10 rounded-lg border border-destructive/20">
                        <p className="text-sm font-semibold text-destructive mb-1">⚠️ Warning</p>
                        <p className="text-xs text-muted-foreground">
                          This action cannot be undone. All your data, including reported incidents and volunteer history, will be permanently deleted.
                        </p>
                      </div>

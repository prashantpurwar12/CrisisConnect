  ...
  return (
    <div className="relative md:col-span-1">
      <input
        ...
        onFocus={onFocus}
        onBlur={onBlur}
        className={`w-full px-4 py-3 bg-input text-foreground border ${error ? "border-destructive" : "border-border"
...
const LoginPage = ({ onSwitchToCreate, onSwitchToOtp, handleAuthSuccess }) => {
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full px-6 py-4 flex items-center justify-center font-semibold text-primary border border-primary rounded-xl hover:bg-primary/10 focus:outline-none focus:ring-4 focus:ring-ring/50 transition-all duration-300 transform hover:-translate-y-1 disabled:opacity-70 disabled:cursor-not-allowed"
          >
            Login with OTP
          </button>
...
const OtpLoginPage = ({ onSwitchToLogin, handleAuthSuccess }) => {
  ...
  return (
    <div className="w-full max-w-md p-8 space-y-6 bg-card/80 backdrop-blur-lg text-card-foreground rounded-3xl shadow-2xl animate-fade-in border border-border/50">
      <div className="text-center space-y-2 mb-8">
        <h2 className="text-3xl font-bold text-foreground">Login with OTP</h2>
        <p className="text-muted-foreground">Secure passwordless login</p>
      </div>
      ...
      <form onSubmit={step === 1 ? handleSendOtp : handleVerifyOtp} className="space-y-8">
        ...
        {step === 1 ? (
          <div className="space-y-2">
            <label htmlFor="otp-email" className="block text-sm font-medium text-foreground">
              Email Address
            </label>
            <InputField
              id="otp-email"
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full px-6 py-4 flex items-center justify-center font-semibold text-primary-foreground bg-primary rounded-xl hover:bg-primary/90 focus:outline-none focus:ring-4 focus:ring-ring/50 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {isLoading ? <Spinner /> : step === 1 ? "Send OTP" : "Verify & Login"}
          </button>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full px-6 py-4 flex items-center justify-center font-semibold text-secondary-foreground bg-secondary rounded-xl hover:bg-secondary/90 focus:outline-none focus:ring-4 focus:ring-ring/50 transition-all duration-300 transform hover:-translate-y-1 disabled:opacity-70 disabled:cursor-not-allowed"
          >
...
export default function AuthSystem() {
  const [view, setView] = useState("login") // login, create, otp
    ...
    <div className="min-h-screen bg-background relative flex items-center justify-center font-sans p-4 overflow-hidden">
      ...
      <div className="relative w-full z-10">
        <div className="text-center mb-8">
          ...
          <p
            className="text-xl text-muted-foreground mt-2 animate-fade-in-down"
